...
<html lang="pt-br">
    ...
    <body>
        <div class="container mt-3">
            <h1 class="text-success">Exercício 11</h1>
            <p>
            ...
            <form action="media.php" method="post">
                <div class="form-floating mb-3 mt-3">
                    <input type="number" class="form-control" placeholder="Digite a nota 1" name="n1" id="n1">
                    <label for="n1">Nota 1</label>
                </div>
                <div class="form-floating mb-3 mt-3">
                    <input type="number" class="form-control" placeholder="Digite a nota 2" name="n2" id="n2">
                    <label for="n2">Nota 2</label>
                </div>
                <div class="form-floating mb-3 mt-3">
                    <input type="number" class="form-control" placeholder="Digite a nota 3" name="n3" id="n3">
